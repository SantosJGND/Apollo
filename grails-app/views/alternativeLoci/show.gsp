			...
			<ol class="property-list availableStatus">
				...
				<li class="fieldcontain">
					<span id="value-label" class="property-label"><g:message code="availableStatus.name.label" default="Properties" /></span>
						...
						<span class="property-value" aria-labelledby="value-label"><g:fieldValue bean="${alternativeLociInstance}" field="name"/></span>
						<span class="property-value" aria-labelledby="value-label"><g:fieldValue bean="${alternativeLociInstance}" field="start"/></span>
						<span class="property-value" aria-labelledby="value-label"><g:fieldValue bean="${alternativeLociInstance}" field="end"/></span>
